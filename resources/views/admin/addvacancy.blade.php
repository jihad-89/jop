                            ...
                            <div class="col-xs-12">
                                <div class="box">
                                    <div class="box-body">
                                        ...
                                        @endif
                                        <form class="form-horizontal span6" action="{{url('admin/savevacancy')}}" method="POST">
                                            @csrf
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-8">
                                                    ...
                                                    <input class="form-control input-sm" id="OCCUPATIONTITLE"
                                                     name="occuptitle" placeholder="Occupation Title"   autocomplete="none" required /> 
                                                    </div>
                                                </div>
                                            </div>  
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        type="number" id="REQ_NO_EMPLOYEES" name="numofemp" placeholder="Required no. of Employees"   autocomplete="none" required /> 
                                                    </div>
                                                </div>
                                            </div>  
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        name="duration" placeholder="Duration of Employment"   autocomplete="none" required /> 
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-8">
                                                        ...
                                                        id="QUALIFICATION_WORKEXPERIENCE" name="experience" placeholder="Qualification/Work Experience"   autocomplete="none" required ></textarea> 
                                                    </div>
                                                </div>
                                            </div> 
                                                ...
                                                <div class="col-md-8">
                                                    ...
                                                    <div class="col-md-8">
                                                        <textarea class="form-control input-sm" id="JOBDESCRIPTION"
                                                         name="description" placeholder="Job Description"   autocomplete="none" required ></textarea> 
                                                    </div>
                                                </div>
                                            </div>  
